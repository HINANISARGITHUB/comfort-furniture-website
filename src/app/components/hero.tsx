...
async function getData() {
  const Query = "*[_type == 'heroImage'][0]";  /*1st query*/
    ...
    <div className="flex justify-center items-center">
      <div className="w-full max-w-screen-xl h-auto bg-[#F0F2F3] flex flex-col sm:flex-row justify-between items-center px-6 sm:px-10 lg:px-16 py-6">
        ...
        <div className="flex flex-col justify-center items-center sm:items-start w-full sm:w-1/2 space-y-4 sm:space-y-6">
          ...
          <button className="bg-[#029FAE] w-[171px] text-white py-3 px-6 rounded-[8px] flex items-center gap-[20px] hover:bg-blue-700 mx-auto sm:mx-0 border-none">
            <span>Shop Now</span>
            <svg
        ...
        {/* Right Section */}
        <div className="w-full sm:w-1/2 mt-14 sm:mt-0 sm:ml-[130px] flex justify-center">
        <Image
